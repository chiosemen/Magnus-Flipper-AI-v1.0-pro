      ...
      <div className="container mx-auto px-4">
        ...
        {isMenuOpen && (
          <>
            ...
            />
            {/* Menu */}
            <div className="fixed left-0 right-0 top-16 bg-background border-t border-border/50 animate-fade-in z-50 lg:hidden max-h-[calc(100vh-4rem)] overflow-y-auto">
