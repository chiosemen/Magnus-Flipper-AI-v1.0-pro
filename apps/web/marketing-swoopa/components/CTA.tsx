...
const CTA = () => {
  ...
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-br from-[#00E5FF]/40 to-[#7B2FFF]/40 blur-3xl opacity-50" />
