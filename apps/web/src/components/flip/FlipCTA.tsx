    ...
    <section className="rounded-2xl border border-cyan-500/30 bg-gradient-to-r from-cyan-500/10 via-indigo-500/10 to-slate-950/90 p-6 sm:p-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-2">
          <h3 className="text-2xl font-semibold text-white">Ready to flip faster?</h3>
          <p className="text-sm text-slate-200">
            Start a 7-day free trial and let Magnus watch the marketplaces for you.
          </p>
        </div>
