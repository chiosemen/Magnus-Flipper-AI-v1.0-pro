 ...
 */
export function generateFingerprint(profile: MarketplaceProfile): RequestFingerprint {
 ...
 */
export function getComplianceConstraints(profile: MarketplaceProfile): ComplianceConstraints {
  return {
    ...
    minDelayBetweenRequests: Math.floor(
      (profile.recommendedPingIntervalSeconds * 1000) / profile.maxRequestsPerMinutePerIp
    ),
  };
}
