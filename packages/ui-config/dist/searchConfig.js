...
exports.MODELS_BY_MANUFACTURER = exports.MANUFACTURERS_BY_CATEGORY = exports.CATEGORIES = void 0;
exports.getManufacturersForCategory = getManufacturersForCategory;
exports.getModelsForManufacturer = getModelsForManufacturer;
exports.getAllModelsForManufacturer = getAllModelsForManufacturer;
exports.CATEGORIES = [
...
exports.MANUFACTURERS_BY_CATEGORY = {
    phones: [
...
exports.MODELS_BY_MANUFACTURER = {
    apple: [
        {
 ...
 */
function getManufacturersForCategory(categoryId) {
    return exports.MANUFACTURERS_BY_CATEGORY[categoryId] || [];
}
/**
 * Get model series for a given manufacturer
 */
function getModelsForManufacturer(manufacturerId) {
    return exports.MODELS_BY_MANUFACTURER[manufacturerId] || [];
}
/**
 * Get all models flattened for a manufacturer
 */
function getAllModelsForManufacturer(manufacturerId) {
    const series = exports.MODELS_BY_MANUFACTURER[manufacturerId] || [];
