/**
 * Gumtree Scraper Test Harness
 * Tests Gumtree marketplace scraper with sample query
 */

import { scrape } from "../../packages/gumtree-crawler/src/index";

async function testGumtreeScraper(): Promise<void> {
  console.log("=".repeat(60));
  console.log("GUMTREE SCRAPER TEST");
  console.log("=".repeat(60));
  ...
  try {
    ...
    console.log("=".repeat(60));
    console.log("✓ GUMTREE TEST PASSED");
    console.log("=".repeat(60));
  } catch (error: any) {
    console.error("\n❌ GUMTREE TEST FAILED");
