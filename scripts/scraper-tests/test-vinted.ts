/**
 * Vinted Scraper Test Harness
 * Tests Vinted marketplace scraper with sample query
 */

import { scrape } from "../../packages/vinted-crawler/src/index";

async function testVintedScraper(): Promise<void> {
  console.log("=".repeat(60));
  console.log("VINTED SCRAPER TEST");
  console.log("=".repeat(60));
  ...
  try {
    ...
    console.log("=".repeat(60));
    console.log("✓ VINTED TEST PASSED");
    console.log("=".repeat(60));
  } catch (error: any) {
    console.error("\n❌ VINTED TEST FAILED");
