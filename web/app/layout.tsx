...
import { MagnusProvider } from "@magnus-flipper-ai/sdk/client";
    ...
    <html lang="en">
      <head>
        ...
        <meta
          ...
          content="Scan, Flip, and Profit Smarter — Powered by Magnus-Tech.AI"
        />
        <meta property="og:image" content="https://flipperagents.com/og-image.png" />
        <meta name="theme-color" content="#00C4FF" />
      </head>
      <body>
        <MagnusProvider options={{ baseURL: process.env.NEXT_PUBLIC_API_URL }}>
          {children}
        </MagnusProvider>
      </body>
    </html>
